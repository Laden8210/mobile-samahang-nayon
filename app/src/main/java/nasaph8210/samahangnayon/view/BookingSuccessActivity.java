...
public class BookingSuccessActivity extends AppCompatActivity implements PostCallback {
    ...
    public void onPostSuccess(String responseData) {
        ...
        Log.d("BookingSuccessActivity", "Response Data: " + responseData);


        viewReservationButton.setOnClickListener(v -> {
            startActivity(new Intent(BookingSuccessActivity.this, HeroActivity.class));
            finish();
        });
